...
public class ElmaActivity extends AppCompatActivity {
...
ImageView imageView;
 ...
 sepeteekle.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            sepett.put("urun","elma");
            String val= miktar.getText().toString();
            int a= Integer.parseInt(val);
            sepett.put("miktar",a);
            sepett.put("tutar",a*8);
            sepett.put("urun","elma");
            myRef.child("elma").updateChildren(sepett);
            Toast.makeText(ElmaActivity.this, "Sepetiniz güncellendi", Toast.LENGTH_SHORT).show();
        }
    });
}
